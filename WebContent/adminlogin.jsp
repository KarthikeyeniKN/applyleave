...
<body>
	<div id="about">
		<p>Goshen College of Engineering and Technology</p>
	</div>
	<div id="login">
		<h2>
			Admin Login <a href="studentlogin.jsp"><button type="submit"
					class="btn btn-success waves-effect">Student Login</button> </a>
		</h2>
