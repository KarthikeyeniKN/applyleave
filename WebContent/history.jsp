...
<body class="grey lighten-3" id="fontstyle">
	<header>
		...
		<div class="row wow fadeIn" id="LeaveList">
		 ...
		 <form class="form-inline md-form form-sm active-cyan active-cyan-2" method="post" action="SearchServlet">
                    <i class="fa fa-search" aria-hidden="true"></i>
                    <input class="form-control form-control-sm ml-3 w-75" type="text" name="search" id="search" placeholder="Search">
         </form>
		<div class="card">
			<!--Card content-->
			<div class="card-body">
