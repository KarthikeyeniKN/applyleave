create table apply_pass(id number(10),name varchar(30)not null,department varchar(20)not null,year number(5)not null,
...
create table student_login(id number(10),name varchar2(40)not null,password varchar2(20)not null,
